...
const InternalPerson = (props) => {
      ...
      },
      {
            ...
            width: '100px',
            render: (text, row) => {
                  return <span style={{ color: '#1890ff', cursor: "pointer", }} onClick={() => getPicModal(row, 'pic')}>{row.name}</span>
            }
      },
       {
            title: '派遣状态',
      ...
      },
      {
            ...
            hideInSearch: true,
            render: (text, row) => {
                  return <span>{row.recommendUnit}/{row.recommendDepartment}</span>
            }
      },
      {
            title: '计算机熟练程度',
      ...
      },
      {
            ...
            render: (text, row, index, action) => {
                  return (
                        <Space>
                              <AuthBtn key={row.id} onClick={e => modalVisible(row, 'editer')} style={{ cursor: "pointer", color: '#1E98D7' }}>编辑</AuthBtn>
                        </Space>
                  );
            }
      }]
